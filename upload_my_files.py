...
tasks = [
    ...
    loop.create_task(uploadMediaFiles('gifs', bot.send_animation, 'animation')),
    loop.create_task(uploadMediaFiles('video', bot.send_video, 'video')),
    loop.create_task(uploadMediaFiles('voice', bot.send_voice, 'voice'))
]
